...
# xcom_pull in the template). The flow_path should point to an existing .sas file that is accessible from the
...
task1 = SASStudioFlowOperator(task_id='demo_program',
                              flow_path_type='compute',
                              flow_type='program',
                              flow_path='/path/to/test.sas',
                              flow_exec_log=True,
...
task2 = SASStudioFlowOperator(task_id='demo_program_2',
                              flow_path_type='raw',
                              flow_type='program',
                              flow_path=program2,
                              flow_exec_log=True,
